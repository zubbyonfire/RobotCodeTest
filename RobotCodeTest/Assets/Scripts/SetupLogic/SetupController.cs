...
{
    /// <summary>
    /// What this script does: Sets up all the inital values in the SO Variables that are used, also makes sure robot and plane are both in the scene - if not it spawns them
    /// </summary>
    public class SetupController : MonoBehaviour
    {
        ...
        [SerializeField]
        private SO2DVector3Array gridPositions = null;
        [SerializeField]
        ...
        private void SetupRobot()
        {
            ...
            if (robotObject == null)
            {
                ...
                robotObject.transform.position = new Vector3(8, 1, -6);
