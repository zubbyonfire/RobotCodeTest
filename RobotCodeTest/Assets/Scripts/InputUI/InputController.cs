...
namespace RobotCodeTest
{
    ...
    public class InputController : MonoBehaviour
    {
        ...
        //Size of grid if we start at 0,0
        ...
        [Header("Time between Command Execution")]
        [SerializeField]
        ...
        void Start()
        {
            ...
            updatedGridSize = new Vector2(UpdateGridSize(grid.value.x), UpdateGridSize(grid.value.y));
