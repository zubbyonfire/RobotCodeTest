...
{
    /// <summary>
    /// What this script does: move the robot 1 space forward in the direction it's facing, if it would fall off the grid we ignore the command
    /// </summary>
    public class MoveRobot : MonoBehaviour
    {
        ...
        /// <summary>
        /// Check to make sure movement is valid
        /// </summary>
